          ...
          Meteor.call(
            ...
            (error, result) => {
              if (error) {
                ...
                if (
                  instance.mail_available.get() &&
                  instance.pseudo_available.get()
                ) {
                  ...
                  instance.find("#divform").innerHTML +=
                  ...
                  Meteor.call(
                    ...
                    (error, result) => {
                      ...
                      if (error) {
                        ...
                        Meteor.loginWithPassword(
                          ...
                          error => {
                            if (!error) {
                              ...
                              instance.find("#divform").innerHTML = null;
                              instance.find("#divform").innerHTML +=
                                "Votre proposition d'aide a bien été enregistré.<br> <a href='/'>Retourner sur la page d'accueil</a>";
                            } else {
                              //A géré les autres erreurs
                              document.getElementById("psw").value = "";
                              instance.find("#error").innerHTML = null;
                              instance.find("#error").innerHTML +=
                        ...
                        instance.find("#error").innerHTML = null;
                        instance.find("#error").innerHTML +=
                          "Le pseudo et l'email ne correspondent pas.<br>";
                        document.getElementById("psw").value = "";
                      }
                    }
                  );
                  ...
                  instance.find("#error").innerHTML = null;
                  instance.find("#error").innerHTML +=
                    "Le pseudo, l'email ou le mot de passe sont incorrect ou déjà utilisé.<br>";
                }
